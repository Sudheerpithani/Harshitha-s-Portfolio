...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: "Web Development",
      github: "https://github.com/DhanyuniHarshitha",
      demo: "https://github.com/DhanyuniHarshitha",
      image: Weatherapp,
      featured: false,
      isImageProject: true,
    },
    {
      title: "Login App",
      description:
        "A simple yet robust application for user authentication, allowing registration, login, and session management with secure credential validation. The project highlights authentication workflows, form validation, database connectivity, and security practices, forming the foundation for scalable user management systems.",
      technologies: ["HTML","CSS","JavaScript", "Node.js with Express.js","MySQL"],
      category: "Web Development",
      github: "https://github.com/DhanyuniHarshitha",
      demo: "https://github.com/DhanyuniHarshitha",
      image: "🔐",
